...
-(id)initWithView:(PLViewBase *)aView
{
	if(self = [self init])
		view = aView;
	return self;
...
-(id)initWithView:(PLViewBase *)aView camera:(PLCamera *)camera
{
...
-(id)initWithView:(PLViewBase *)aView element:(PLSceneElement *)element
{
...
-(id)initWithView:(PLViewBase *)aView element:(PLSceneElement *)element camera:(PLCamera *)camera
{
